...
Source Database       : igeekshop

Target Server Type    : MYSQL
Target Server Version : 50547
File Encoding         : 65001

Date: 2019-08-01 16:22:05
*/
...
INSERT INTO `category` VALUES ('15', '肯德基');
INSERT INTO `category` VALUES ('16', '汉堡王');
...
-- ----------------------------
INSERT INTO `orderitem` VALUES ('1', '1', '3300', '1', '1');
INSERT INTO `orderitem` VALUES ('2', '1', '1499', '3', '88aa2d69-0206-471d-b20f-086599bdd7e7');
INSERT INTO `orderitem` VALUES ('3', '1', '6688', '32', '88aa2d69-0206-471d-b20f-086599bdd7e7');
INSERT INTO `orderitem` VALUES ('4', '1', '4199', '33', '68ec2df8-566b-4354-8e4d-dd6176bcf2d0');
INSERT INTO `orderitem` VALUES ('5', '1', '1499', '3', '68ec2df8-566b-4354-8e4d-dd6176bcf2d0');
INSERT INTO `orderitem` VALUES ('6', '1', '4199', '33', '5d0d39b1-bb52-4e8c-9eb6-c88f403659cb');
...
CREATE TABLE `orders` (
  ...
  KEY `oufk_0001` (`uid`) USING BTREE,
  CONSTRAINT `oufk_0001` FOREIGN KEY (`uid`) REFERENCES `user` (`uid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;

-- ----------------------------
-- Records of orders
-- ----------------------------
INSERT INTO `orders` VALUES ('1', '2019-07-10 00:00:00', '3300', '0', '吴家山', '付康', '123456', '10');
INSERT INTO `orders` VALUES ('5d0d39b1-bb52-4e8c-9eb6-c88f403659cb', '2019-08-01 11:05:00', '4199', '0', '222', '222', '222', '10');
INSERT INTO `orders` VALUES ('68ec2df8-566b-4354-8e4d-dd6176bcf2d0', '2019-07-31 20:29:48', '5698', '0', '111', '111', '111', '10');
INSERT INTO `orders` VALUES ('88aa2d69-0206-471d-b20f-086599bdd7e7', '2019-07-30 18:43:05', '8187', '0', '111', '111', '111', '10');
...
INSERT INTO `product` VALUES ('63', 'x', '1', '1', 'upload/s1.jpg', '2019-08-01', '1', '', '0', '1');
INSERT INTO `product` VALUES ('64', '111', '111', '111', 'upload/s1.jpg', '2019-08-01', '1', '', '0', '1');
...
INSERT INTO `user` VALUES ('2', 'bb', 'bb', '张三', 'bbb@store.com', '15723689921', '1990-02-01', '男', '0', '1258e96181a9457987928954825189000bae305094a042d6bd9d2d35674684e6');
INSERT INTO `user` VALUES ('3', 'cc', 'cc', '张三', 'bbb@store.com', '15723689921', '2015-11-03', '男', '0', '19f100aa81184c03951c4b840a725b6a98097aa1106a4a38ba1c29f1a496c231');
INSERT INTO `user` VALUES ('4', 'bbb', 'bbb', '老王', 'bbb@store.com', '15712344823', '2000-02-01', '男', '0', '71a3a933353347a4bcacff699e6baa9c950a02f6b84e4f6fb8404ca06febfd6f');
INSERT INTO `user` VALUES ('5', 'aaa', 'aaa', '小王', 'aaa@store.com', '15712344823', '2000-02-01', '男', '1', null);
INSERT INTO `user` VALUES ('10', '付康', '123123', 'fmk', 'cangdan9295@163.com', null, '2019-07-10', '男', '1', '47493b07-6ac7-40df-866f-6a2a880c5444');
