...
<script type="text/javascript">
    function addCart() {
        ...
        location.href="addProductToCart?pid=${product.pid}&buyNum="+buyNum;
    }
</script>
</head>
	...
	<div class="container">
		<div class="row">
			<div
				...
				<a href="indexServlet">首页&nbsp;&nbsp;&gt;</a> <a href="SelectProduct?cid=${product.category.cid}">${product.category.cname }&nbsp;&nbsp;&gt;</a>
				<a>${product.pname }</a>
			</div>
