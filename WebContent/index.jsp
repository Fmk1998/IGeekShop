	...
	<body>
		...
		<div class="container-fluid">
			...
			<div class="container-fluid">
				...
				<div class="col-md-2 hidden-sm hidden-xs" style="border:1px solid #E7E7E7;border-right:0;padding:0;">
					<img src="products/hao/big01.jpg" width="205" height="404" style="display: inline-block;"/>
				</div>
				<div class="col-md-10">
					<div class="col-md-6 hidden-sm hidden-xs" style="text-align:center;height:200px;padding:0px;">
